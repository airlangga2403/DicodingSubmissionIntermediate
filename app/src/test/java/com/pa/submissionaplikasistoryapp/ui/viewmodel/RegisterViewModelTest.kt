...
import com.pa.submissionaplikasistoryapp.utils.DataDummy
import com.pa.submissionaplikasistoryapp.utils.MainDispatcherRule
import com.pa.submissionaplikasistoryapp.utils.getOrAwaitValue
...
class RegisterViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(registerRepository.getStories()).thenReturn(expectedStory)
        val actualStory: PagingData<ListStoryItem> =
            RegisterViewModel(registerRepository).getStories().getOrAwaitValue()
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> = registerViewModel.getStories().getOrAwaitValue()
